...
public class Method06 extends AMethod {
	 ...
	 */
	public final int[][] getSpecialRest() {
		return specialRest;
	}
	 ...
	 */
	public final boolean isDoSubtractFirst() {
	 ...
	 */
	public final void setDoSubtractFirst(final boolean paramaDoSubtractFirst) {
	 ...
	 * @return bla
	 */
	public final int transformResult(final int result) {
