...
public class Method91 extends Method06 {
	...
	/**
	 */
	static final int[] WEIGHT_1 = new int[] { 7, 6, 5, 4, 3, 2, -1, -1, -1, -1 };

	/**
	 */
	static final int[] WEIGHT_2 = new int[] { 2, 3, 4, 5, 6, 7, -1, -1, -1, -1 };

	/**
	 */
	static final int[] WEIGHT_3 = new int[] { 10, 9, 8, 7, 6, 5, 0, 4, 3, 2 };

	/**
	 */
	static final int[] WEIGHT_4 = new int[] { 9, 10, 5, 8, 4, 2, -1, -1, -1, -1 };

	/**
	 */
	private Object[] weightArray = null;
