...
public class Method90 extends Method06 {
	...
	/**
	 */
	private static final int MODULO_D = 9;

	/**
	 */
	private static final int MODULO_E = 10;
	...
	/**
	 */
	private static final int[] WEIGHT_B = new int[] { -1, -1, -1, -1, 6, 5, 4, 3, 2, -1 };

	/**
	 */
	private static final int[] WEIGHT_E = new int[] { -1, -1, -1, -1, 2, 1, 2, 1, 2, -1 };

	/**
	 */
	private static final int[] WEIGHT_SACH = new int[] { -1, -1, 8, 7, 6, 5, 4, 3, 2,
			-1 };

	/**
	 */
	private final Object[][] weightModuloArray;
