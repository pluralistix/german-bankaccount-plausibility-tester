...
public abstract class AMethod {
	...
	/**
	 */
	private static final int DEFAULTCHECKDIGITPOSITION = 10;

	/**
	 */
	private static final int DEFAULTMODULO = 10;
	 ...
	 *            bla
	 */
	private static void syntaxCheck(@SuppressWarnings("SameParameterValue") final int blz, final String accountNumber) {
	 ...
	 *            bla
	 */
	protected final void doValidate(final int result, final boolean paramUnitPosition) {
	 ...
	 */
	protected final int getCheckDigit() {
	 ...
	 */
	protected final String getNormalizedAccountNumber() {
	 ...
	 */
	private boolean isUnitPosition() {
		return unitPosition;
	}
	 ...
	 */
	private boolean isSubstractRestFromTen() {
	...
	public final int myHash() {
		String sb = getCheckDigitPosition() + "|" +
				getModulo() + "|" +
				(getCrossSum() == null ? "null" : getCrossSum() + "|") +
				(getWeight() == null ? "null" : Arrays.toString(getWeight())
						+ "|") +
				isUnitPosition() + "|" +
				isValid();
		return sb.hashCode();
	 ...
	 *            bla
	 */
	protected final void setAccountNumber(final String paramAccountNumber,
	 ...
	 */
	protected final void setNormalizedAccountNumber(
	 ...
	 */
	protected final void setSubstractRestFromTen(
			@SuppressWarnings("SameParameterValue") final boolean paramSubstractRestFromTen) {
	 ...
	 *            the valid to set
	 */
	protected final void setValid(final boolean paramValid) {
		valid = paramValid;
	}
