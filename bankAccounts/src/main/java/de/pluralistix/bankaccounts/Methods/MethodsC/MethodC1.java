...
public class MethodC1 extends Method17 {
	...
	/**
	 */
	private final int checkDigistPositionFromSuper;

	/**
	 */
	private final ArrayList<Integer> querSumme = new ArrayList<>(4);

	/**
	 */
	private final ArrayList<Integer> querSummeFromSuper;
